...
# fort.16 file path
file_path = '/home/jce18b/Esparza_SPS/2025_06_13C_campaign/6Lid/9Be6Lid_fresco/7688keV/fort.16'
...
# # Load exp data
# ods_file = os.path.expanduser('/home/jce18b/Esparza_SPS/2023_01_9Be_6Li_d/ang_dists/totalangdistdata.ods')
...
plt.scatter(df[0][362:542], df[1][362:542], color='green', label='DWBA: l = 1')
plt.yscale('log')
plt.xlabel('CM Angles (degrees)')
plt.ylabel('Cross sections (mb/sr)')
