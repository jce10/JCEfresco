...
# fort.16 file path
file_path = '/home/jce18b/Esparza_SPS/2025_06_13C_campaign/6Lid/9Be6Lid_fresco/dwba_combined/fort.16'
...
# # separate plots for my data and Aslanoglou's data. start with 6.86 MeV
...
# plt.scatter(df_esp.iloc[0], df_esp.iloc[2], color='red', label='Esparza')
# plt.yscale('log')
# plt.xlabel('CM Angles (degrees)')
# plt.ylabel('Cross sections (mb/sr)')
...
# # 7.65 MeV
# plt.figure(figsize=(10, 6))
# plt.scatter(df_esp.iloc[0], df_esp.iloc[3], color='red', label='Esparza')
# plt.yscale('log')
# plt.xlabel('CM Angles (degrees)')
# plt.ylabel('Cross sections (mb/sr)')
...
# plt.scatter(df_esp.iloc[0], df_esp.iloc[6], color='red', label='Esparza')
# plt.yscale('log')
# plt.xlabel('CM Angles (degrees)')
# plt.ylabel('Cross sections (mb/sr)')
...
axs[0, 0].scatter(df[0][1805:1985], df[1][1805:1985], color='green', label='FRESCO DWBA')
axs[0, 0].set_yscale('log')
axs[0, 0].set_xlabel('CM Angles (degrees)')
axs[0, 0].set_ylabel('Cross sections (mb/sr)')
axs[0, 0].set_title('6.86 MeV (5/2+)')
axs[0, 0].grid(True)
axs[0, 0].legend()

# 7.55 MeV
# axs[0, 1].scatter(df_aslan.iloc[2], df_aslan.iloc[3], color='blue', label='Aslanoglou')
# axs[0, 1].scatter(df_esp.iloc[0], df_esp.iloc[2], color='red', label='Esparza')
axs[0, 1].scatter(df[0][1985:2165], df[1][1985:2165], color='green', label='FRESCO DWBA')
axs[0, 1].set_yscale('log')
axs[0, 1].set_xlabel('CM Angles (degrees)')
axs[0, 1].set_ylabel('Cross sections (mb/sr)')
axs[0, 1].set_title('7.55 MeV (5/2-)')
axs[0, 1].grid(True)
axs[0, 1].legend()

# # 7.65 MeV
# axs[0, 2].scatter(df_esp.iloc[0], df_esp.iloc[3], color='red', label='Esparza')
# axs[0, 2].set_yscale('log')
# axs[0, 2].set_xlabel('CM Angles (degrees)')
# axs[0, 2].set_ylabel('Cross sections (mb/sr)')
# axs[0, 2].set_title('7.65 MeV (3/2+)')
# axs[0, 2].grid(True)
# axs[0, 2].legend()

# 9.5 MeV
# axs[1, 0].scatter(df_aslan.iloc[4], df_aslan.iloc[5], color='blue', label='Aslanoglou')
# axs[1, 0].scatter(df_esp.iloc[0], df_esp.iloc[4], color='red', label='Esparza')
axs[1, 0].scatter(df[0][2166:2306], df[1][2166:2306], color='green', label='FRESCO DWBA')
axs[1, 0].set_yscale('log')
axs[1, 0].set_xlabel('CM Angles (degrees)')
axs[1, 0].set_ylabel('Cross sections (mb/sr)')
axs[1, 0].set_title('9.5 MeV (9/2+)')
axs[1, 0].grid(True)
axs[1, 0].legend()

# 9.9 MeV
# axs[1, 1].scatter(df_aslan.iloc[6], df_aslan.iloc[7], color='blue', label='Aslanoglou')
# axs[1, 1].scatter(df_esp.iloc[0], df_esp.iloc[5], color='red', label='Esparza')
axs[1, 1].scatter(df[0][2527:2707], df[1][2527:2707], color='green', label='FRESCO DWBA')
axs[1, 1].set_yscale('log')
axs[1, 1].set_xlabel('CM Angles (degrees)')
axs[1, 1].set_ylabel('Cross sections (mb/sr)')
axs[1, 1].set_title('9.9 MeV (3/2-)')
axs[1, 1].grid(True)
axs[1, 1].legend()

# 10.75 MeV
# axs[1, 2].scatter(df_aslan.iloc[8], df_aslan.iloc[9], color='blue', label='Aslanoglou')
# axs[1, 2].scatter(df_esp.iloc[0], df_esp.iloc[6], color='red', label='Esparza')
axs[1, 2].scatter(df[0][2888:3068], df[1][2888:3068], color='green', label='FRESCO DWBA')
axs[1, 2].set_yscale('log')
axs[1, 2].set_xlabel('CM Angles (degrees)')
axs[1, 2].set_ylabel('Cross sections (mb/sr)')
axs[1, 2].set_title('10.75 MeV (7/2-)')
axs[1, 2].grid(True)
axs[1, 2].legend()
