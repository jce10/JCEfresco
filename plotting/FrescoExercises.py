...
# # ========== CDCC gracias de Ken ========== #
# sections = scrape_fort16_sections("/home/jce18b/Programs/JCEfresco/Exercises/25Aldn/fort.16")
# plot_sections_individually(sections)
# # ========================================================== #


# ========== CDCC gracias de Nick Keeley!!! ========== #

# Warning!!! this file has 63 plots!!!!
# sections = scrape_fort16_sections("/home/jce18b/Programs/JCEfresco/jce/Keeley_cdcc/58Ni6Lid/fort.16")
# plot_sections_individually(sections)

# ========================================================== #

# ========== my first attempt at CDCC!!! ========== #
# 9Be(6Li,d)13C at 32 MeV with breakup of 6Li.
# 

# Warning!!! this file has 63 plots!!!!
sections = scrape_fort16_sections("/home/jce18b/Programs/JCEfresco/jce/9Be6Lid_cdcc/10750keV_short/fort.16")
plot_sections_individually(sections)
